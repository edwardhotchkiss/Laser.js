...
var root = (typeof(require) !== 'undefined' && require.amd) ?
    {} : window;

/**
 * @method dfn
 * @description requirejs define or alternate
 */

var dfn = (typeof(define) === 'function' && define.amd) ? 
  define : function(name, deps, fn) {
    root.Laser = fn.call(this, Logger);
  };

/**
 * @description main fn body with injected AMD modules
 */

(function(root, define) {
  
  define('laser', ['logger'], function(Logger) {
